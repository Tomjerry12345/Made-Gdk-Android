...
public class ListFilm implements Parcelable
{
    ...
    protected ListFilm(Parcel in) {
        ...
        in.readList(this.results, (com.dicoding.submission2.model.film.Result.class.getClassLoader()));
    }
     ...
     * @param totalPages
     */
    public ListFilm(Integer page, Integer totalResults, Integer totalPages, List<Result> results) {
        super();
        this.page = page;
