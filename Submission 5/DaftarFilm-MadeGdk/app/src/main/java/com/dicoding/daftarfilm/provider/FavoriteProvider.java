package com.dicoding.daftarfilm.provider;
...
import com.dicoding.daftarfilm.activity.MainActivity;
import com.dicoding.daftarfilm.db.DatabaseContract;
import com.dicoding.daftarfilm.db.FavoriteHelper;

import static com.dicoding.daftarfilm.db.DatabaseContract.AUTHORITY;
import static com.dicoding.daftarfilm.db.FavoriteHelper.DATABASE_TABLE;
import static com.dicoding.daftarfilm.db.FavoriteHelper.DATABASE_TABLE_FILM;

import static com.dicoding.daftarfilm.db.DatabaseContract.FavoriteColumns.CONTENT_URI;
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case FAVORITE_TV:
                ...
                getContext().getContentResolver().notifyChange(DatabaseContract.FavoriteTvColumns.CONTENT_URI, new MainActivity.DataObserver(new Handler(), getContext()));
                uri.parse(DatabaseContract.FavoriteTvColumns.CONTENT_URI + "/" + added);
                break;
            default:
                added = 0;
                break;
